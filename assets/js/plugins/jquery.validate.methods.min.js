...
jQuery.validator.addMethod("renavam", function(value, element) {
	return this.optional(element) || isRenavam(value);
}, jQuery.format("O número renavam digitado é inválido."));

jQuery.validator.addMethod("cpfcnpj", function(value, element) {
	return this.optional(element) || isCpfCnpj(value);
}, jQuery.format("O cpf/cnpj digitado é inválido."));

jQuery.validator.addMethod("embranco", function(value, element) {
	return this.optional(element) || /^\S+$/i.test(value);
}, "Não é permitido usar espaços neste campo.");

jQuery.validator.addMethod("somenteletras", function(value, element) {
	return this.optional(element) || /^[a-z]+$/i.test(value);
}, "Utilize apenas letras neste campo.");

jQuery.validator.addMethod("alfanumerico", function(value, element) {
	return this.optional(element) || /^\w+$/i.test(value);
}, "Preencha apenas letras, números, espaços ou underline neste campo.");
...
jQuery.validator.addMethod("placa", function(value, element) {
	return this.optional(element) || /[a-z]{3}-?\d{4}/gim.test(value);
}, "A placa do veículo digitada é inválida.");

jQuery.validator.addMethod("dinheiro", function(value, element) {
	return this.optional(element) || /^[+-]?((\d+|\d{1,3}(\.\d{3})+)(\,\d*)?|\,\d+)$/.test(value);
}, "O valor digitado é inválido.");

jQuery.validator.addMethod("naoigual", function(value, element, param) {
  return this.optional(element) || value != param;
}, "Preencha um valor diferente que o informado.");
